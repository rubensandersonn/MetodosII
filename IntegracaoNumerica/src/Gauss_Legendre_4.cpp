...
double NC_F_P1::integrar()
{
    ...
    else
    {
        ...
        integral = NC_F_P1_integracao(m_pIntegrando, m_lInf, m_lSup);
...
double NC_F_P1::NC_F_P1_integracao(Funcao * f, double a, double b)
{
    return ((b-a)/2*(m_pIntegrando->f(a) + m_pIntegrando->f(b)));
}
